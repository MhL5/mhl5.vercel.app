...
<ComponentSource path="src/app/(with-navigation)/snippets/components/StructuredDataScript/index.tsx" />

## Usage Examples

### Basic Usage

<ComponentSource path="src/app/(with-navigation)/snippets/components/StructuredDataScript/Example.tsx" />
