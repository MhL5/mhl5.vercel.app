...
<CodeBlock path="src/app/(with-navigation)/snippets/components/StructuredDataScript/index.tsx" />

## Usage Examples

### Basic Usage

<CodeBlock path="src/app/(with-navigation)/snippets/components/StructuredDataScript/Example.tsx" />
