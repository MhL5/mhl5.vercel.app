...
export default function HeroSection({
  ...
  return (
    ...
    >
      ...
      <h1 className="z-10 mx-2 animate-title cursor-default bg-foreground bg-clip-text px-0.5 py-3.5 text-4xl font-semibold whitespace-nowrap text-transparent duration-300 sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl">
        Mohammad Lashani
      </h1>
